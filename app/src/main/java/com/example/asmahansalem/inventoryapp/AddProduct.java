...
/**
 * Here is a Java code source for AddProduct Activity With full original notes
 * <p>
 * https://github.com/samuolis/Inventory/blob/master/app/src/main/java/com/example/android/inventory/EditActivity.java
 */
public class AddProduct extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonAddImage = (ImageView) findViewById(R.id.select_image);
        ...
        mNameEditText = (EditText) findViewById(R.id.editProduct);
        mPriceEditText = (EditText) findViewById(R.id.price_edit);
        mCountEditText = (EditText) findViewById(R.id.quantity_edit);
        mSupNameEditText = (EditText) findViewById(R.id.edit_supplier_name);
        mSupEmailEditText = (EditText) findViewById(R.id.edit_email);
    ...
    private void saveItem() {
        ...
        values.put(InventoryEntry.COLUMN_ITEM_COUNT, count);
        values.put(InventoryEntry.COLUMN_SUP_NAME, supNameString);
        values.put(InventoryEntry.COLUMN_SUP_EMAIL, supEmailString);

        values.put(InventoryEntry.COLUMN_ITEM_IMAGE, imageByte);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int imageColumnIndex = cursor.getColumnIndex(Contract.InventoryEntry.COLUMN_ITEM_IMAGE);
